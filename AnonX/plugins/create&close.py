...
@app.on_message(filters.regex("^افتح الاتصال$"))
    ...
    try:
      ...
      try:    
        ...
        await msg.edit_text("تم فتح المكالمه بنجاح ⚡️~!")
         ...
         await msg.edit_text("خلي البوت عنده صلاحية اضافة مشرفين والتحكم ف المحادثه الصوتيه او خلي حساب المساعد وجرب ⚡")
@app.on_message(filters.regex("^ سد الاتصال$"))
    ...
    try:
      ...
      if "GROUPCALL_FORBIDDEN" in str(e):
       try:    
         ...
         await msg.edit_text("خلي البوت عنده صلاحية اضافة مشرفين والتحكم ف المحادثه الصوتيه او خلي حساب المساعد عنده صلاحية رفع مشرفين وجرب")
